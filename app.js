...
const movies = [

  {
    ...
    rating: 8.2,
    duration: "2h 14m",
    description: "A retired courier is pulled back into the trade for one final run across a continent that no longer wants him alive.",
    poster: "https://picsum.photos/seed/lastjourney/400/600",
    backdrop: "https://picsum.photos/seed/lastjourney-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Rohan Verma", "Elena Cross", "Marcus Iyer"],
    director: "Kabir Anand",
    keywords: ["heist", "chase", "redemption", "courier"]
  },
  {
    id: "movie002",
    ...
    rating: 7.6,
    duration: "2h 5m",
    description: "Two strangers stranded by a flooded highway spend one rain-soaked night retracing the choices that brought them there.",
    poster: "https://picsum.photos/seed/monsoondiaries/400/600",
    backdrop: "https://picsum.photos/seed/monsoondiaries-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Salman Khan", "Ritika Sen"],
    director: "Anaya Kapoor",
    keywords: ["rain", "love story", "highway", "strangers"]
  },
  {
    id: "movie003",
    title: "Full Volume",
    ...
    rating: 6.9,
    duration: "1h 38m",
    description: "A failing garage band gets one shot at a festival slot — if they can survive their own egos for 72 hours.",
    poster: "https://picsum.photos/seed/fullvolume/400/600",
    backdrop: "https://picsum.photos/seed/fullvolume-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Devika Rao", "Sam Patterson", "Owen Blake"],
    director: "Priya Nandan",
    keywords: ["band", "music", "festival", "friendship"]
  },
  {
    id: "movie004",
    title: "Vettai",
    ...
    rating: 8.0,
    duration: "2h 21m",
    description: "A small-town cop hunts a smuggling ring that reaches further into his own family than he's ready to admit.",
    poster: "https://picsum.photos/seed/vettai/400/600",
    backdrop: "https://picsum.photos/seed/vettai-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Arun Vikram", "Meera Chandran"],
    director: "Bala Murugan",
    keywords: ["crime", "smuggling", "family", "cop"]
  },
  {
    id: "movie005",
    title: "Batman: Shadow Circuit",
    year: 2025,
    language: "English",
    type: "Movie",
    ...
    rating: 8.5,
    duration: "2h 28m",
    description: "A rogue AI trained on Gotham's surveillance grid starts predicting crimes before they happen — and rewriting who commits them.",
    poster: "https://picsum.photos/seed/shadowcircuit/400/600",
    backdrop: "https://picsum.photos/seed/shadowcircuit-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Julian Cole", "Nadia Storm"],
    director: "Victor Han",
    keywords: ["vigilante", "ai", "city", "detective"]
  },
  {
    id: "movie006",
    title: "Batman Begins Again",
    year: 2023,
    language: "English",
    type: "Movie",
    genres: ["Action", "Drama"],
    rating: 7.8,
    duration: "2h 12m",
    description: "Years after hanging up the cape, a former guardian is forced back into the fight when his city forgets how to protect itself.",
    poster: "https://picsum.photos/seed/beginsagain/400/600",
    backdrop: "https://picsum.photos/seed/beginsagain-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Julian Cole", "Frank Osei"],
    director: "Victor Han",
    keywords: ["comeback", "legacy", "vigilante"]
  },
  {
    id: "movie007",
    ...
    rating: 7.1,
    duration: "1h 56m",
    description: "A bio-engineer bitten during a lab accident starts hearing every conversation in the city at once — and one of them is a threat.",
    poster: "https://picsum.photos/seed/webofsilence/400/600",
    backdrop: "https://picsum.photos/seed/webofsilence-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Theo Marsh", "Ayesha Malik"],
    director: "Grace Liu",
    keywords: ["superhero", "lab accident", "city", "senses"]
  },
  {
    id: "movie008",
    title: "Spinning Homeward",
    year: 2021,
    language: "English",
    type: "Movie",
    ...
    rating: 7.4,
    duration: "2h 1m",
    description: "A teenager balancing homework and a secret double life has to choose between saving his neighborhood and making it to prom.",
    poster: "https://picsum.photos/seed/spinninghomeward/400/600",
    backdrop: "https://picsum.photos/seed/spinninghomeward-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Theo Marsh", "Lena Osei"],
    director: "Grace Liu",
    keywords: ["superhero", "teenager", "school", "coming of age"]
  },
  {
    id: "movie009",
    title: "Naveena",
    ...
    rating: 7.9,
    duration: "2h 18m",
    description: "A daughter returns to her ancestral village to settle a land dispute and instead uncovers the truth about her mother's past.",
    poster: "https://picsum.photos/seed/naveena/400/600",
    backdrop: "https://picsum.photos/seed/naveena-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Sruthi Raghavan", "Vamsi Krishna"],
    director: "Lakshmi Prasanna",
    keywords: ["village", "family secret", "inheritance"]
  },
  {
    id: "movie010",
    title: "Nadhiyil Oru Kadhal",
    year: 2023,
    language: "Tamil",
    type: "Movie",
    ...
    rating: 7.5,
    duration: "2h 9m",
    description: "A boatman and a marine biologist fall for each other across a river that both their families have spent decades fighting over.",
    poster: "https://picsum.photos/seed/nadhiyil/400/600",
    backdrop: "https://picsum.photos/seed/nadhiyil-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Arjun Kannan", "Meera Chandran"],
    director: "Bala Murugan",
    keywords: ["river", "love story", "family feud"]
  },
  {
    id: "movie011",
    title: "Punch Line",
    ...
    rating: 7.2,
    duration: "1h 52m",
    description: "A struggling stand-up comic bombs her way through a city tour, bombing on stage but slowly rebuilding her life offstage.",
    poster: "https://picsum.photos/seed/punchline/400/600",
    backdrop: "https://picsum.photos/seed/punchline-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Ritika Sen", "Farhan Qureshi"],
    director: "Anaya Kapoor",
    keywords: ["stand-up", "comedy tour", "self discovery"]
  },
  {
    id: "movie012",
    title: "Cold Front",
    ...
    rating: 6.8,
    duration: "1h 47m",
    description: "A research team snowed in at an Arctic station realizes the storm outside isn't the only thing hunting them.",
    poster: "https://picsum.photos/seed/coldfront/400/600",
    backdrop: "https://picsum.photos/seed/coldfront-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Nadia Storm", "Owen Blake"],
    director: "Victor Han",
    keywords: ["arctic", "survival", "isolation", "monster"]
  },
  {
    id: "movie013",
    title: "The Boardroom",
    ...
    rating: 8.1,
    duration: "6 Seasons",
    description: "Three siblings circle their aging father's media empire while the company quietly runs out of runway beneath them.",
    poster: "https://picsum.photos/seed/boardroom/400/600",
    backdrop: "https://picsum.photos/seed/boardroom-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Marcus Iyer", "Elena Cross", "Frank Osei"],
    director: "Kabir Anand",
    keywords: ["family business", "power struggle", "media empire"]
  },
  {
    id: "movie014",
    title: "Gully Kings",
    ...
    rating: 7.7,
    duration: "2h 16m",
    description: "A street cricket league becomes the only thing holding a neighborhood together as developers move in on the ground.",
    poster: "https://picsum.photos/seed/gullykings/400/600",
    backdrop: "https://picsum.photos/seed/gullykings-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Salman Khan", "Devika Rao"],
    director: "Priya Nandan",
    keywords: ["cricket", "neighborhood", "underdog"]
  },
  {
    id: "movie015",
    ...
    rating: 7.3,
    duration: "2h 4m",
    description: "A farmer's cooperative fights to save a valley's last free-flowing river from a dam project promising prosperity.",
    poster: "https://picsum.photos/seed/idhunamma/400/600",
    backdrop: "https://picsum.photos/seed/idhunamma-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Chetan Gowda", "Sruthi Raghavan"],
    director: "Lakshmi Prasanna",
    keywords: ["farmers", "river", "dam", "community"]
  },
  {
    id: "movie016",
    title: "Moner Kotha",
    ...
    rating: 7.6,
    duration: "2h 3m",
    description: "A letter-writer in old Kolkata falls for the woman whose love letters he's been ghostwriting for another man.",
    poster: "https://picsum.photos/seed/monerkotha/400/600",
    backdrop: "https://picsum.photos/seed/monerkotha-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Rishi Sengupta", "Anwesha Dutta"],
    director: "Debjani Roy",
    keywords: ["letters", "old city", "love triangle"]
  },
  {
    id: "movie017",
    title: "Zunka Bhakar",
    ...
    rating: 7.0,
    duration: "1h 44m",
    description: "A roadside dhaba owner and his rival next door are forced into an unlikely partnership when a food inspector shuts them both down.",
    poster: "https://picsum.photos/seed/zunkabhakar/400/600",
    backdrop: "https://picsum.photos/seed/zunkabhakar-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Sameer Joshi", "Kavita Pawar"],
    director: "Nikhil Deshmukh",
    keywords: ["food", "rivalry", "small business"]
  },
  {
    id: "movie018",
    title: "Yaari Badshah",
    ...
    rating: 6.7,
    duration: "1h 58m",
    description: "Two childhood friends turned rival truck-union bosses have to team up when both their businesses are targeted by the same crooks.",
    poster: "https://picsum.photos/seed/yaaribadshah/400/600",
    backdrop: "https://picsum.photos/seed/yaaribadshah-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Gurpreet Bajwa", "Simran Kaur"],
    director: "Harjit Sandhu",
    keywords: ["friendship", "trucking", "rivalry"]
  },
  {
    id: "movie019",
    title: "Ottayal",
    ...
    rating: 8.3,
    duration: "2h 8m",
    description: "A ferry operator on a backwater route becomes the only witness to a crime he can't afford to report.",
    poster: "https://picsum.photos/seed/ottayal/400/600",
    backdrop: "https://picsum.photos/seed/ottayal-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Vishnu Menon", "Anjali Pillai"],
    director: "Rahul Sasi",
    keywords: ["backwaters", "witness", "silence"]
  },
  {
    id: "movie020",
    title: "Orbit Falling",
    ...
    rating: 8.0,
    duration: "2h 22m",
    description: "A maintenance crew on a decaying space station has 96 hours to fix a failing reactor before it takes the orbit's only city with it.",
    poster: "https://picsum.photos/seed/orbitfalling/400/600",
    backdrop: "https://picsum.photos/seed/orbitfalling-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Nadia Storm", "Theo Marsh", "Ayesha Malik"],
    director: "Grace Liu",
    keywords: ["space station", "countdown", "disaster"]
  },
  {
    id: "movie021",
    title: "Paper Moons",
    ...
    rating: 8.4,
    duration: "1h 39m",
    description: "A folded paper crane comes to life for one night to help a lonely origami-maker find her way back to her estranged sister.",
    poster: "https://picsum.photos/seed/papermoons/400/600",
    backdrop: "https://picsum.photos/seed/papermoons-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Voice: Mira Kapoor", "Voice: Owen Blake"],
    director: "Priya Nandan",
    keywords: ["animation", "family", "sisters", "magic"]
  },
  {
    id: "movie022",
    ...
    rating: 7.8,
    duration: "1h 32m",
    description: "A look inside the small-town credit union that survived three recessions by refusing to grow past its own neighborhood.",
    poster: "https://picsum.photos/seed/quietledger/400/600",
    backdrop: "https://picsum.photos/seed/quietledger-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: [],
    director: "Frank Osei",
    keywords: ["finance", "small town", "community"]
  },
  {
    id: "movie023",
    title: "Amaravati Express",
    year: 2025,
    language: "Telugu",
    type: "Movie",
    ...
    rating: 7.4,
    duration: "2h 10m",
    description: "A ticket collector accidentally swaps briefcases with a fugitive financier and spends one wild overnight train ride finding out.",
    poster: "https://picsum.photos/seed/amaravati/400/600",
    backdrop: "https://picsum.photos/seed/amaravati-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Vamsi Krishna", "Sruthi Raghavan"],
    director: "Lakshmi Prasanna",
    keywords: ["train", "mistaken identity", "chase"]
  },
  {
    id: "movie024",
    ...
    rating: 8.6,
    duration: "3 Seasons",
    description: "A decommissioned intelligence unit is reactivated to stop a rogue satellite network from rewriting the world's borders.",
    poster: "https://picsum.photos/seed/horizonprotocol/400/600",
    backdrop: "https://picsum.photos/seed/horizonprotocol-bg/1600/900",
    videoUrl: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4",
    cast: ["Julian Cole", "Elena Cross", "Marcus Iyer"],
    director: "Kabir Anand",
    keywords: ["espionage", "satellites", "borders", "team"]
  }
];

// Featured movies shown in the homepage hero carousel
movies.unshift(...featuredAdditions);

const featuredMovieIds = ["movie001", "movie005", "movie004", "movie020", "movie024"];
